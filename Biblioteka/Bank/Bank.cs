...
namespace Bank
{
    ...
    {
        BankServiceImplementation ssImp;
        public Bank(StatefulServiceContext context)
            : base(context)
        {
            ssImp = new BankServiceImplementation(this.StateManager, Context.PartitionId.ToString());
        }
        ...
        private ICommunicationListener CreateWcfCommunicationListener(ServiceContext context)
        {
            ...
            return new WcfCommunicationListener<IBank>(context, ssImp, WcfUtility.CreateTcpListenerBinding(), uriPrefix);
        }
